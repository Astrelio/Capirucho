-- ============================================
-- RESET: elimina schema viejo (camelCase) y aplica el definitivo.
...
drop table if exists "dineTable" cascade;
drop table if exists "zone" cascade;
drop table if exists "menuItem" cascade;
drop table if exists "menuCat" cascade;
drop table if exists "review" cascade;
drop table if exists "waitlist" cascade;
drop table if exists "profile" cascade;
drop table if exists "restaurant" cascade;

-- Por si hubo intentos previos del schema nuevo
...
drop function if exists atomic_reserve cascade;
...
create index idx_reservations_date on reservations(restaurant_id, date, time_start);
create index idx_reservations_table on reservations(table_id, date);
